package sp.org.app0710.graphic2;
...
public class MainFrame extends JFrame implements ActionListener{
	...
	public MainFrame() {
		...
		p = new JPanel() {
			...
			public void paint(Graphics g) {
				...
				//Toolkit을 이용하는 방법 (해당 OS에 의존적인 경로로 이미지를 얻는 방법)
		...
		bt.addActionListener(this); //버튼과 리스너연결
		bt2.addActionListener(this); //버튼과 리스너연결
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(obj==bt) {
			...
			//따라서 버튼만 눌러서 그림을 다시 그리는 효과를 내려면, 시스템에게 paint() 메서드를
